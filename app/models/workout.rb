class Workout < ActiveRecord::Base
  ...
  validates_attachment_size :mp3_part_one, :less_than => 5.megabytes, :message => "must be smaller than 5Mb"
	validates_attachment_content_type :mp3_part_one, :content_type => 'audio/mpeg', :message => "is invalid (must be MP3 file)"

  validates_attachment_size :mp3_part_two, :less_than => 5.megabytes, :message => "must be smaller than 5Mb"
	validates_attachment_content_type :mp3_part_two, :content_type => 'audio/mpeg', :message => "is invalid (must be MP3 file)"

	validates_attachment_size :mp3_part_three, :less_than => 5.megabytes, :message => "must be smaller than 5Mb"
	validates_attachment_content_type :mp3_part_three, :content_type => 'audio/mpeg', :message => "is invalid (must be MP3 file)"

	validates_attachment_size :mp3_unguided, :less_than => 5.megabytes, :message => "must be smaller than 5Mb"
